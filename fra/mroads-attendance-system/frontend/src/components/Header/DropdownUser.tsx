...
const DropdownUser = () => {
  ...
  useEffect(() => {
    ...
    // Also listen for custom event from ProfileHeader
    ...
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      >
        <span className="hidden text-right lg:block">
          ...
          <span className="block text-xs">{userEmail || 'User'}</span>
        </span>

        <span className="h-12 w-12 rounded-full">
          <img src={profileImage} alt="User" className="h-full w-full rounded-full object-cover" />
        </span>
